...
namespace Final_Project
{
    public partial class Expenses : Form
    {
        ...
        private void buttonReset_Click(object sender, EventArgs e)
        {
            ...
            lbTotal.Text = sumExpenses.reSum().ToString();
            lbListMin.Text = sumExpenses.reListMin().ToString();
            lbExMin.Text = sumExpenses.reMin().ToString();
            lbListMax.Text = sumExpenses.reListMax().ToString();
            lbExMax.Text = sumExpenses.reMax().ToString();
        }  
