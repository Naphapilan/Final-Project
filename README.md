...
```
โปรแกรมบันทึกรายรับรายจ่ายของของตนเอง สร้างขึ้นเพื่อต้องการที่จะทราบว่าเราใช้จ่ายอะไรบ้างและใช้เงินเป็นจำนวนเท่าไหร่ และต้องการทราบว่ารายรับเรามีเท่าไหร่
```
