...
```
โปรแกรมบันทึกรายรับรายจ่ายของของตนเอง เป็นโปรแกรมที่สร้างขึ้นมาก็เพื่อแก้ปัญหาการใช้จ่ายเงินและต้องการที่จะทราบว่าเราใช้จ่ายอะไรบ้างและใช้เงิน
เป็นจำนวนเท่าไหร่ และต้องการทราบว่ารายรับเรามีเท่าไหร่
```
